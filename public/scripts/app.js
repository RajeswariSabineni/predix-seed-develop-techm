...
define([
    ...
    predixApp.controller('MainCtrl', ['$scope', '$rootScope', 'PredixUserService', function ($scope, $rootScope, predixUserService) {
        ...
        window.App = $rootScope.App = {
            ...
            session: {},
            tabs: [
                {icon: 'fa-file-o', state: 'px-data-table', label: 'px-data-table'	},
                {icon: 'fa-file-o', state: 'px-charts', label: 'px-charts'},
                {icon: 'fa-file-o', state: 'input-components', label: 'input components'}
            ]
        };
